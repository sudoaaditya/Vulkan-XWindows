...
// Global Variables
const char* gpszAppName = "AMK_VulkanXWindowsApp : 2D Rotation - Colored Two Shapes";
...
// For Rotation
float fAngleTriangle = 0.0f;
float fAngleRectangle = 0.0f;
...
void uninitialize(void) {
    ...
    if(uniformData_triangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Uniform Buffer for Triangle!\n");
    ...
    if(uniformData_triangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Uniform Buffer for Triangle!\n");
    ...
    if(uniformData_rectangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Uniform Buffer for Rectangle!\n");
    ...
    if(uniformData_rectangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Uniform Buffer for Rectangle!\n");
    ...
    if(vertexData_position_triangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Triangle Position!\n");
    ...
    if(vertexData_position_triangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Triangle Position!\n");
    ...
    if(vertexData_color_triangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Triangle Color!\n");
    ...
    if(vertexData_color_triangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Triangle Color!\n");
    ...
    if(vertexData_position_rectangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Rectangle Position!\n");
    ...
    if(vertexData_position_rectangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Rectangle Position!\n");
    ...
    if(vertexData_color_rectangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Rectangle Color!\n");
    ...
    if(vertexData_color_rectangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Rectangle Color!\n");
...
VkResult createVertexBuffer(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Failed for Triangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Successful for Triangle Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Failed for Triangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Successful for Triangle Position!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_position_triangle.vkBuffer, vertexData_position_triangle.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Failed for Triangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Successful for Triangle Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Failed for Triangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Successful for Triangle Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Failed for Triangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Successful for Triangle Color!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Failed for Triangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Successful for Triangle Color!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_triangle.vkBuffer, vertexData_color_triangle.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Failed for Triangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Successful for Triangle Color!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Failed for Triangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Successful for Triangle Color!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Failed for Rectangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Successful for Rectangle Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Failed for Rectangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Successful for Rectangle Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Failed for Rectangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Successful for Rectangle Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Failed for Rectangle Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Successful for Rectangle Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Failed for Rectangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Successful for Rectangle Color!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Failed for Rectangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Successful for Rectangle Color!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_rectangle.vkBuffer, vertexData_color_rectangle.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Failed for Rectangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Successful for Rectangle Color!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Failed for Rectangle Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Successful for Rectangle Color!.\n");
    }
...
VkResult createUniformBuffer (void) {
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createUniformBuffer(): vkCreateBuffer() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createUniformBuffer(): vkCreateBuffer() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createUniformBuffer(): vkAllocateMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createUniformBuffer(): vkAllocateMemory() Successful for Triangle!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, uniformData_triangle.vkBuffer, uniformData_triangle.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createUniformBuffer(): vkBindBufferMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createUniformBuffer(): vkBindBufferMemory() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createUniformBuffer(): vkCreateBuffer() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createUniformBuffer(): vkCreateBuffer() Successful for Rectangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createUniformBuffer(): vkAllocateMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createUniformBuffer(): vkAllocateMemory() Successful for Rectangle!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, uniformData_rectangle.vkBuffer, uniformData_rectangle.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createUniformBuffer(): vkBindBufferMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createUniformBuffer(): vkBindBufferMemory() Successful for Rectangle!.\n");
    }

    // call updateUniformBuffer() to fill the uniform buffer with data
    vkResult = updateUniformBuffer();
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createUniformBuffer(): updateUniformBuffer() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
...
VkResult updateUniformBuffer(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "updateUniformBuffer(): vkMapMemory() Failed for Triangle!.\n");
        return (vkResult);
    }
...
VkResult createDescriptorSet(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createDescriptorSet(): vkAllocateDescriptorSets() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createDescriptorSet(): vkAllocateDescriptorSets() Successful for Triangle!.\n");
    }
    ...
    vkDescriptorBufferInfo.buffer = uniformData_triangle.vkBuffer; // this is the buffer we want to use as uniform
    ...
    vkWriteDescriptorSet.dstSet = vkDescriptorSet_triangle; // this is the descriptor set we want to update
    ...
    fprintf(fptr, "createDescriptorSet(): vkUpdateDescriptorSets() Successful for Triangle!.\n");
    ...
    vkDescriptorBufferInfo.buffer = uniformData_rectangle.vkBuffer; // this is the buffer we want to use as uniform
    vkDescriptorBufferInfo.offset = 0; // offset is 0
    vkDescriptorBufferInfo.range = sizeof(struct MyUniformData); // range is size of uniform
    ...
    vkWriteDescriptorSet.sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    vkWriteDescriptorSet.pNext = NULL;
    vkWriteDescriptorSet.dstSet = vkDescriptorSet_rectangle; // this is the descriptor set we want to update
    vkWriteDescriptorSet.dstArrayElement = 0; // we have only one descriptor set, so array element is 0
    vkWriteDescriptorSet.descriptorCount = 1; // we are only gonna write one descriptor set
    vkWriteDescriptorSet.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER; 
    vkWriteDescriptorSet.pBufferInfo = &vkDescriptorBufferInfo;
    ...
    fprintf(fptr, "createDescriptorSet(): vkUpdateDescriptorSets() Successful for Reactangle!.\n");
...
VkResult buildCommandBuffers(void) {
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++) {
        ...
        vkCmdBindDescriptorSets(
            ...
            vkPipelineLayout,
            0, 1,
            &vkDescriptorSet_triangle, // this is the descriptor set we want to bind
            0, NULL
        );
        ...
        vkCmdBindDescriptorSets(
            ...
            vkPipelineLayout,
            0, 1,
            &vkDescriptorSet_rectangle, // this is the descriptor set we want to bind
            0, NULL
        );
