...
// Global Variables
const char* gpszAppName = "AMK_VulkanXWindowsApp : Two Shapes - Multiple Pipeline";
...
VkResult initialize(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "initialize(): createPipeline() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "initialize(): createPipeline() Successful for Triangle!.\n\n");
    }

    vkResult = createPipeline(&vkPipeline_rectangle, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST);
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "initialize(): createPipeline() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "initialize(): createPipeline() Successful for Rectangle!.\n\n");
    }
...
void uninitialize(void) {
    ...
    if(vertexData_position_triangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for triangle!\n");
    ...
    if(vertexData_position_triangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for triangle!\n");
    ...
    if(vertexData_position_rectangle.vkDeviceMemory) {
        ...
        fprintf(fptr, "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Rectangle!\n");
    ...
    if(vertexData_position_rectangle.vkBuffer) {
        ...
        fprintf(fptr, "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Rectangle!\n");
...
VkResult createVertexBuffer(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Successful for Triangle!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_position_triangle.vkBuffer, vertexData_position_triangle.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkCreateBuffer() Successful for Rectangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkAllocateMemory() Successful for Rectangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkBindBufferMemory() Successful for Rectangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): vkMapMemory() Successful for Rectangle!.\n");
    }
...
VkResult createPipeline(VkPipeline *pPipeline, VkPrimitiveTopology primitiveTopology) {
    // Variables
    VkResult vkResult = VK_SUCCESS;
    ...
    vkPipelineInputAssemblyStateCreateInfo.topology = primitiveTopology; // sent as parameter
    ...
    // Assign the created pipeline to the output parameter
...
VkResult buildCommandBuffers(void) {
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++) {
        ...
        // For Triangle
        // Bind with the pipeline triangle
