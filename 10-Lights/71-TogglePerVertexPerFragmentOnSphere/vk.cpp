...
// Global Variables
const char* gpszAppName = "AMK_VulkanXWindowsApp : Toggle Per Vertex And Per Fragment Light On Sphere";
...
VkResult updateUniformBuffer(void) {
    ...
    if(bPerVertex) {
        myUniformData.isPerVertex = 1;
    } else {
        myUniformData.isPerVertex = 0;
    }
