...
// Global Variables
const char* gpszAppName = "AMK_VulkanXWindowsApp : Two Rotating Lights On Pyramid";
...
VkResult updateUniformBuffer(void) {
    ...
    myUniformData.lightPositionA[0] = 2.0f;
    myUniformData.lightPositionA[1] = 0.0f;
    myUniformData.lightPositionA[2] = 0.0f;
    myUniformData.lightPositionA[3] = 1.0f;
    ...
    myUniformData.lightDiffuseB[1] = 0.0f;
    myUniformData.lightDiffuseB[2] = 1.0f;
    myUniformData.lightDiffuseB[3] = 1.0f;

    myUniformData.lightSpecularB[0] = 0.0f;
    myUniformData.lightSpecularB[1] = 0.0f;
    myUniformData.lightSpecularB[2] = 1.0f;
    myUniformData.lightSpecularB[3] = 1.0f;

    myUniformData.lightPositionB[0] = -2.0f;
    myUniformData.lightPositionB[1] = 0.0f;
    myUniformData.lightPositionB[2] = 0.0f;
    myUniformData.lightPositionB[3] = 1.0f;
